...
vim.api.nvim_set_hl(0, 'GitSignsAdd', { fg = '#a8ff51' })           -- Verde claro
vim.api.nvim_set_hl(0, 'GitSignsChange', { fg = '#08b7f8' })        -- azul claro
...
vim.api.nvim_set_hl(0, 'GitSignsStagedAdd', { fg = '#e5fc22' })      -- Verde más claro
vim.api.nvim_set_hl(0, 'GitSignsStagedChange', { fg = '#82fcca' })   -- Amarillo más claro
